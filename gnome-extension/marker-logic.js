...
export const OPENROUTER_RANK_FIELDS = Object.freeze([
    [FIELD.orTop1Model, FIELD.orTop1Price],
    [FIELD.orTop2Model, FIELD.orTop2Price],
    [FIELD.orTop3Model, FIELD.orTop3Price],
    [FIELD.orTop4Model, FIELD.orTop4Price],
    [FIELD.orTop5Model, FIELD.orTop5Price],
    [FIELD.orTop6Model, FIELD.orTop6Price],
    [FIELD.orTop7Model, FIELD.orTop7Price],
    [FIELD.orTop8Model, FIELD.orTop8Price],
    [FIELD.orTop9Model, FIELD.orTop9Price],
    [FIELD.orTop10Model, FIELD.orTop10Price],
]);
...
export function hasUsageWindows(vendorShort) {
    return !['dsk', 'opr'].includes(field(vendorShort));
}
